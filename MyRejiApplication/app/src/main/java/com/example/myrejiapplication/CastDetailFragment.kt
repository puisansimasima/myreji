...
import com.example.myrejiapplication.databinding.FragmentCastDetailBinding
 ...
 * Use the [CastDetailFragment.newInstance] factory method to
...
class CastDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addCastButton.setOnClickListener {
            ...
            val action = CastDetailFragmentDirections.actionCastDetailFragmentToCastFragment()
