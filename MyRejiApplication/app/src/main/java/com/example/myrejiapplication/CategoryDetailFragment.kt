...
import com.example.myrejiapplication.databinding.FragmentCategoryDetailBinding
...
class CategoryDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.saveCategoryButton.setOnClickListener {
            ...
            val action=
                CategoryDetailFragmentDirections.actionCategoryDetailFragmentToCategoryFragment()
